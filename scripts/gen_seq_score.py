...
# 输入输出文件路径
fasta_file = "./500L/5%/500L-0.05_0001.ref"
fastq_file = './500L/5%/500L-0.05_0001.fastq'
maf_file = './500L/5%/500L-0.05_0001.maf'
seq_output_file = "500L/5%/55500L-0.05.seq"
score_output_file = "500L/5%/555score.ans"
...
def calculate_score_and_write(cigar_strings, score_file_path):
...
# 解析MAF文件并生成CIGAR字符串
cigar_strings = parse_maf_and_compute_cigar(maf_file)

# 计算得分并写入文件
calculate_score_and_write(cigar_strings, score_output_file)
